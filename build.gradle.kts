...
tasks.register("publishLocal") {
    ...
    dependsOn(
        ":auto-register:publishToMavenLocal",
        ":auto-register-processor:publishToMavenLocal",
        ":auto-register-dynamic-feature:publishToMavenLocal"
    )
}

/**
 * Task to automate Git Add, Commit, Push, and Tagging.
